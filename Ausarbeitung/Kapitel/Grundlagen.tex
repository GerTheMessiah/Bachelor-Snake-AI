...
\subsubsection{Zusammenfassung der PPO Training Objective Function} \label{sec:PPO_Training_Objective_Function}
...
\subsection{PPO - Algorithmus} \label{sec:PPO_Algorithmus}
...
\subsection{DQN - Algorithmus} \label{alg:DQN}
