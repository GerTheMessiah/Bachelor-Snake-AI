...
Diese bieten sich, wie in den Abschnitten \fullref{sec:Grundlagen_PPO} und \fullref{sec:Grundlagen_Deep_Q_Learning} beschrieben, für den Vergleich an.
...
\section{Anforderungen an die Statistiken} \label{sec:Anforderungen_Statistik}
Das System muss in der Lage sein, Statistiken generieren und speichern zu können. Diese sollen für die Evaluation verwendet werden. Zu jedem Evaluationskriterium \fullref{tab:Anforderungen_Kriterien} soll eine Statistik erstellt werden. 
