...
class Agent:
    def __init__(self, lr_actor=1e-3, lr_critic=1.5e-3, gamma=0.99, K_epochs=10, eps_clip=0.2, gpu=True):
        self.gamma = gamma
    ...
    def learn(self, memory):
        ...
        for _ in range(self.K_epochs):
            ...
            surr2 = T.clamp(ratios, min=1 - self.eps_clip, max=1 + self.eps_clip) * advantages
